...
<div class="ninenty">
<img class="image2" src="images\oneplus11.jpg">
...
<img class="image3" src="images\oneplus5.png">
</div>

<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="OnePlus 9RT 5G Nano Silver 8GB|128GB">
<!--<h2 class="yu">OnePlus 9RT 5G Nano Silver 8GB|128GB</h2>-->
<p class="brnd">Brand: OnePlus</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star-o" aria-hidden="true"></i>
<hr>
<h3 class="se">₹39,999.00</h3>
...
<div class="sub_section1">
<img class="image3" src="images\oneplus4.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="OnePlus Nord CE 2 5G Gray Mirror 8GB">

<!--<h2 class="yu">OnePlus Nord CE 2 5G Gray Mirror 8GB|128GB</h2>-->
<p class="brnd">Brand: OnePlus</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="sub_section1">
<img class="image3" src="images\oneplus2.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="OnePlus 8 Intersteller Glow 12GB|256GB">
<!--<h2 class="yu">OnePlus 8 Intersteller Glow 12GB|256GB</h2>-->
<p class="brnd">Brand:OnePlus</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="sub_section1">
<img class="image4" src="images\oneplus333.jpg">
</div>
<div class="sub_section2_2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="OnePlus Nord CE 5G Charcoal Ink 12GB">
<!--<h2 class="yu">OnePlus Nord CE 5G Charcoal Ink 12GB|256GB</h2-->
<p class="brnd">Brand:OnePlus</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="sub_section1">
<img class="image3" src="images\oneplus1.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Oneplus 10T  MoonStone Black 12GB">
<!--<h2 class="yu">Oneplus 10T 5G MoonStone Black 12GB|256GB</h2>-->
<p class="brnd">Brand:OnePlus</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
