...
<div class="ninenty">
<img class="image2" src="images\vivo11.jpg">
...
<img class="image3" src="images\vivo1.2.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Vivo V25 Pro 5G Sailing Blue 8GB|128GB">
<!--<h2 class="yu">Vivo V25 Pro 5G Sailing Blue 8GB|128GB</h2>-->
<p class="brnd">Brand: Vivo</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star-o" aria-hidden="true"></i>
<hr>
<h3 class="se">₹36,099.00</h3>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3_4" src="images\vivo2.png">
</div>
<div class="sub_section2_2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Vivo Y01 Elegant Black 2GB|32GB">
<!--<h2 class="yu">Vivo Y01 Elegant Black 2GB|32GB</h2>-->
<p class="brnd">Brand: Vivo</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3" src="images\vivo3.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Vivo V23 5G Stardust Black 8GB |128GB">
<!--<h2 class="yu">Vivo V23 5G Stardust Black 8GB |128GB</h2>-->
<p class="brnd">Brand: Vivo</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3" src="images\vivo5.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Vivo Y21T Midnight Blue 4GB|128GB">
<!--<h2 class="yu">Vivo Y21T Midnight Blue 4GB|128GB</h2>-->
<p class="brnd">Brand: Vivo</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
