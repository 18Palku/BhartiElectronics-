...
<div class="ninenty">
<img class="image2" src="images\relame1.jpg">
...
<img class="image3" src="images\realmeph1.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Realme C31 Dark Green 4GB|64GB">
<!--<h2 class="yu">Realme C31 Dark Green 4GB|64GB</h2>-->
<p class="brnd">Brand: Realme</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star-o" aria-hidden="true"></i>
<hr>
<h3 class="se">₹10,099.00</h3>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3" src="images\realmeph2.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Realme C21Y Cross Black 3 GB RAM">
<!--<h2 class="yu">Realme C21Y Cross Black 3 GB RAM</h2>-->
<p class="brnd">Brand: Realme</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star-o" aria-hidden="true"></i>
<hr>
<h3 class="se">₹9,599.00 </h3>
<p class="ja">Order Now & get the product delivered between  <b>31 Aug 2022 - 3 Sep 2022</b> </p>
<p class="oi">EMI starts at ₹ per month<p>
<button type="submit" class="btn1">Buy Now</button>
<button class="btn2" onclick="cart()">Add to Cart</button>
</div></div>
</div>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3" src="images\realmeph4.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Realme GT 2 Pro Steel Black 8GB|128GB">
<!--<h2 class="yu">Realme GT 2 Pro Steel Black 8GB|128GB</h2>-->
<p class="brnd">Brand: Realme</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<div class="ninenty">
<div class="sub_section1">
<img class="image3" src="images\realmeph5.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Realme C31 Light Silver 3GB|32GB">
<!--<h2 class="yu">Realme C31 Light Silver 3GB|32GB</h2>-->
<p class="brnd">Brand: Realme</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
...
<img class="image4" src="images\realmeph6.png">
</div>
<div class="sub_section2">
<form action="billingform.php" method="POST">
<input type="text" name="mobile" class="alpha" value="Realme C11 2021 Cool Grey 4GB | 64GB">
<!--<h2 class="yu">Realme C11 2021 Cool Grey 4GB | 64GB</h2>-->
<p class="brnd">Brand: Realme</p>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>
